<%-- 
    Document   : weekPage
    Created on : Jul 30, 2018, 9:47:04 PM
    Author     : Ratul
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="list">
                <h1 class="header">This Week's Items.</h1>

                <ul class="items">
                    <%
                        try {
                            PreparedStatement statement = con.prepareStatement(
                                    "SELECT * FROM items where YEARWEEK(created, 1)=YEARWEEK(CURDATE(), 1) and id = '" + (Integer) session.getAttribute("userID") + "'");
